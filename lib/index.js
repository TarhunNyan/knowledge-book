...
// if (paths_inp === -1) { throw new Error(Директория ${fromFolder} не найдена) }
// if (paths_out === -1) { throw new Error(Директория ${saveFolder} не найдена) }

// var paths_check = fp.filesCompare(paths_inp, paths_out)
